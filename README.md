...
<head>
    ...
    <style>
body {
            background-image: url(https://png.pngtree.com/thumb_back/fw800/background/20240525/pngtree-art-of-lighting-of-incandescent-bulb-close-image_15730457.jpg);
            height: 100vh;
            width: 100vw;
...
h1{
    ...
    font-family: Georgia;
    color:rgb(238, 248, 42);
}
form{
    border: 5px dashed yellow;
    background-color: rgb(253, 115, 212) ;
    padding: 30px;
    margin: 10px;
    border-radius: 20px;
    width: 500px;
...
![alt text](<Screenshot 2025-05-02 111452.png>)

## HOMEPAGE:
![alt text](<Screenshot 2025-05-02 130028.png>)
